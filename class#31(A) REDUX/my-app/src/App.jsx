...
//redux store ka folder ma aik folder bnaya ha action ka naam sa jis ma humna aik 
//index.js     ki file bnae ha 

//action==>jitna bhi functional kaam hoga wo like firebase sa data lena ha 
//reducer ==>hamri state ka lia hogya jo ka global hogiglo
//ABHI MERE Application redux sa connect ho gae ab hum apna store ko globally usd kis tarh kra ga wo dekhta ha
import {connect} from 'react-redux'
//globally used krna ka lia mna connect naam ka aik component ha jo react-redux sa milta ha wo ma import kro ga
// /connect humko 2 function deta ha   jis ko jum export sa phela bnata ha nicha 
import Child from "./component/child.js"
import {set_data} from './ReduxStore/action';
class App extends Component{
  constructor(){
    super()
    this.state={
...
// }
  render(){
    ...
    // this.props islya likha ha kyua redux humara tamam cheeza/property ko this.props ma dal deta ha 
...
{/* yani agr count > tb taq increment ho is ka  baat componentWillUnmount yani  DElete */}
         ...
         <button onClick={()=>this.setState({count:this.state.count+1})}>   Increment        </button>
           <button onClick={()=>this.setState({count:this.state.count-1})}>Decrement</button>
           <br/>
           <button onClick={()=>this.props.set_data("bhai data yha sa bhi la sakta ho")}>Set Data</button>
...
//ya properties a lia hota 
const mapStateToProps = (state ) => {
   return{
  //    name:state.name,
  //  email:"mudassirraza12345@gmail.com"
    
//jb mera ziada store ho ga to ma isko bataao ga ka kon sa reducer sa import kr rha hon  
username:state.auth.username,
email:state.auth.email,
app_name:state.app.app_name
}
}
// mna jo store/reducer/index.js ma  initial state ma jo ghous likha ha wo humko yha mila ga through mapStateToProps
//is ka lia mujha is fuction ko link krna hoga connect sa

//second connect function
//isma hum state update dekha ga
//ya functions ka lia hota ha  
//yani actions

//mna is function ki file bnali or is ko import
// import {set_data} from './ReduxStore/action';
...
//redux kheta ha agr apko muj sa koi funtion kaam krana ha to apko aik library used krni hogi middleware
//middleware Redux thumb ki library sa ata ha islya humko aik or libray install krna para gi jis
//npm i redux-thunk
//isko ReduxStore/index.js ma import kro ga 
// const store =createStore(reducer,{},applyMiddleware(thunk))
//  export default store;

//import thunk from 'redux-thunk'
//redux sa Middleware import kro ga 
//import { createStore,applyMiddleware } from 'redux'



// connect hum sa 2 value leta ha aik ha 1)mapStateToProps 2)mapDispatchToProps
